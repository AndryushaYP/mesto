...
// Вы писали "Данный массив можно вынести в отдельный файл utils.js  и подключить его к основному файлу скриптов 
// ( в данном случае index.js). Это позволит сделать размер index.js меньше 
// и в дальнейшем упростит работу с моковыми данными." Я не нашёл способ сделать это без подключения сторонних 
// библиотек/сборщиков. Нашел функцию, которая делает это, но отзывы о ней "не очень".
