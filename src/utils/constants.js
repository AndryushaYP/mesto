...
//Кнопки
export const buttonSubmitEdit = popupEdit.querySelector('.popup__button'); //профиль
export const buttonSubmitAdd = popupAdd.querySelector('.popup__button'); //карточка
export const buttonSubmitAvatar = popupAvatar.querySelector('.popup__button'); //аватар
